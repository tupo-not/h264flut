...
#spawn uall
udp_ch1 = Gst.ElementFactory.make("udpsrc","udp_ch1")
cfilt_ch1 = Gst.ElementFactory.make("capsfilter","cfilt_ch1")
depay_ch1 = Gst.ElementFactory.make("rtph264depay","depay_ch1")
que_ch1 = Gst.ElementFactory.make("queue","que_ch1")
decodee_ch1 = Gst.ElementFactory.make("avdec_h264","decode_ch1")
scale_ch1 = Gst.ElementFactory.make("videoscale","scale_ch1")
rescale_ch1 = Gst.ElementFactory.make("capsfilter","rescale_ch1")
fallback_ch1 = Gst.ElementFactory.make("fallbackswitch","fallback_ch1")
imgfrz_ch1 = Gst.ElementFactory.make("imagefreeze","imgfrz_ch1")
bottomtext_ch1 = Gst.ElementFactory.make("textoverlay","bottomtext_ch1")
toptext = Gst.ElementFactory.make("textoverlay","toptext")
pholder_ch1 = Gst.ElementFactory.make("videotestsrc","pholder_ch1")
scale_phold_ch1 = Gst.ElementFactory.make("videoscale","scale_phold_ch1")
res_phold_ch1 = Gst.ElementFactory.make("capsfilter","res_phold_ch1")

...
! textoverlay font-desc=impact text="No NSFW plz | Output resolution is 800x600 | running by CHANGEME and Gstreamer" auto-resize=false \
halignment=5 valignment=5 xpos=0.5 ypos=0.98 \
! textoverlay font-desc=impact text="UDP A.B.C.D port EEEE | ONLY h264" auto-resize=false \
...
! textoverlay name=textoverlay16 silent=false text="NOVIDEO0)0))" halignment=1 scale-mode=0 valignment=4 line-alignment=1 font-desc=arial auto-resize=false ! fallbackswitch14. 
...
! "video/x-raw,width=800,height=600,pixel-aspect-ratio=(fraction)1/1" ! fallbackswitch name=novideo_switch immediate-fallback=true timeout=5000000000 \
...
! textoverlay name=novideotext silent=false text="NOVIDEO0)0))" halignment=1 \
scale-mode=0 valignment=4 line-alignment=1 font-desc=arial auto-resize=false ! novideo_switch. 
